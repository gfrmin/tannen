#!/usr/bin/env bash
# M4 DRAFT (all three fixtures accepted) — for review. The driver's step 6 does NOT install this
# file: it assembles the same hunks over the live custodian for the fixtures actually installed.
